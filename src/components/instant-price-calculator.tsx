      ...
      <div className="container-x">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="mt-3 text-muted-foreground text-sm sm:text-base">
            Select your device brand, model, and issue to get an instant estimated repair price with
            genuine parts.
          </p>
        </div>

        <Card className="max-w-4xl mx-auto border-border shadow-xl rounded-3xl overflow-hidden bg-card/60 backdrop-blur">
          <CardContent className="p-6 sm:p-8 grid md:grid-cols-12 gap-8 items-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {Object.keys(ISSUES).map((issue) => (
                    <button
                      ...
                      className={`p-3 rounded-xl text-xs text-left border font-medium transition-all ${
                        selectedIssue === issue
                          ? "border-blue-600 bg-blue-500/10 text-foreground font-semibold"
            ...
            <div className="md:col-span-5 p-6 rounded-2xl bg-slate-900 text-white space-y-5 shadow-inner border border-white/10">
              <div className="space-y-1">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-xs text-slate-400">inc. VAT &amp; Labour</span>
                </div>
              </div>
              ...
              <Button
                asChild
                className="w-full rounded-xl h-12 text-sm font-semibold bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-600/30"
              >
                <Link to="/book">
                  Book This Repair Now <ChevronRight className="ml-1 h-4 w-4" />
                </Link>
              </Button>

              <div className="text-[10px] text-center text-slate-400 flex items-center justify-center gap-1">
                <CheckCircle2 className="h-3 w-3 text-emerald-400" />
                No Fix, No Fee — Free Diagnostics Included
              </div>
            </div>
          </CardContent>
        </Card>
