  ...
  return (
    <>
        ...
        <div className="container-x flex items-center justify-between h-9">
          ...
          <div className="flex items-center gap-5">
            <a
              ...
              className="flex items-center gap-1.5 font-semibold hover:text-[#e21b23] transition-colors"
              aria-label={`Call MR. KHAN on ${business.phone}`}
            >
              <Phone className="w-3.5 h-3.5 text-[#e21b23] shrink-0" />
              Call {business.phone}
            </a>
            <a
      ...
      <div className="w-full bg-[#07101d] text-white text-[11px] h-[26px] px-3 flex items-center justify-between md:hidden border-b border-white/10">
        <a
          href={`tel:${business.phoneRaw}`}
          className="flex items-center gap-1 font-semibold hover:text-[#e21b23] transition-colors"
          aria-label={`Call MR. KHAN on ${business.phone}`}
        >
          <Phone className="w-3 h-3 text-[#e21b23]" />
          {business.phone}
        </a>
